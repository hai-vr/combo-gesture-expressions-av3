...
namespace Hai.ComboGesture.Scripts.Editor.EditorUI.Layouts
{
    public class CombinerState
    {
        ...
        public void DoSetCombiner(ComboGestureActivity activity, AnimationClip leftAnim, AnimationClip rightAnim, string propertyPath, bool usePermutations, Action repaintCallback)
        {
            Combiner = new CgeActivityEditorCombiner(activity, leftAnim, rightAnim, repaintCallback);
            Combiner.Prepare();
