...
namespace Hai.ComboGesture.Scripts.Editor.EditorUI.Effectors
{
    ...
    public class CgeActivityPreviewQueryAggregator
    {
        ...
        public CgeActivityPreviewQueryAggregator(CgeMemoization cgeMemoization, CgeEditorEffector editorEffector, CgeBlendTreeEffector blendTreeEffector, CgeRenderingCommands renderingCommands)
        {
