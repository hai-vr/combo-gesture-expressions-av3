...
namespace Hai.ComboGesture.Scripts.Editor.Internal.CgeAac
{
    public static class CgeAacV0
    {
        ...
        {
            asset.name = "CGE/zAutogenerated__" + component.AssetKey + "__" + suffix + "_" + Random.Range(0, Int32.MaxValue); // FIXME animation name conflict
        ...
        {
            clip.name = "CGE/zAutogenerated__" + component.AssetKey + "__" + suffix + "_" + Random.Range(0, Int32.MaxValue); // FIXME animation name conflict
    ...
    public struct CgeAacFlLayer
    {
        ...
        public CgeAacFlLayer ResolveAvatarMask(Transform[] paths)
        {
            ...
            avatarMask.name = "CGE/zAutogenerated__" + _configuration.AssetKey + "_" + _fullLayerName + "__AvatarMask";
        ...
        public void ClearPreviousAssets()
        {
            ...
            foreach (var subAsset in allSubAssets)
            {
                if (subAsset.name.StartsWith($"zAutogenerated__{_configuration.AssetKey}__") ||
                    subAsset.name.StartsWith($"CGE/zAutogenerated__{_configuration.AssetKey}__")
