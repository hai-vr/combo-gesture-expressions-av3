...
{
    public class EeLocalization
    {
        private const string Prefix = "ee.";
        private const string Suffix = ".json";
        private static readonly EeLocalization Myself = new EeLocalization();
        ...
        {
            var localizationGuids = AssetDatabase.FindAssets("", new[] {"Assets/Hai/ExpressionsEditor/Scripts/Editor/EditorUI/Locale"});
